...
import { FaGraduationCap, FaChartBar, FaBuilding, FaUsers, FaUserTie } from 'react-icons/fa';
        ...
        <Col md={12} className="text-center">
          <div className="hero-section py-5">
            ...
            <p className="lead mb-4">
              Giải pháp quản lý toàn diện cho các mượn phòng, quản lý tránh xung đột
            </p>
        ...
        <Col md={4} className="mb-4">
          <Card className="h-100 feature-card">
            <Card.Body className="text-center">
              <FaChartBar size={40} className="text-primary mb-3" />
              <Card.Title>Thống kê phản hồi</Card.Title>
              <Card.Text>
                Thu thập các đánh giá và điều chỉnh để cải thiện chất lượng dịch vụ.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
