...
public class QuanLyController {
    ...
    public ResponseEntity<?> getRoomFeedbackStatistics() {
        ...
        for (PhanHoi feedback : recentFeedbacksData) {
            ...
            // Lấy thông tin phòng từ phản hồi (qua lịch sử mượn phòng và yêu cầu mượn phòng)
            ...
            // Lấy thông tin người dùng từ phản hồi (qua lịch sử mượn phòng và yêu cầu mượn phòng)
