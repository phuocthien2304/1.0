...
public interface LichSuMuonPhongRepository extends JpaRepository<LichSuMuonPhong, Integer> {
    ...
    List<LichSuMuonPhong> findByYeuCauMuonPhongMaYeuCauOrderByThoiGianMuonDesc(Integer maYeuCau);
    List<LichSuMuonPhong> findByYeuCauMuonPhongOrderByThoiGianMuonDesc(YeuCauMuonPhong yeuCauMuonPhong);
    List<LichSuMuonPhong> findByThoiGianTraThucTeIsNull();
} 