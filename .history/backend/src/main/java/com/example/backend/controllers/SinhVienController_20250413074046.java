...
public class SinhVienController {
    ...
    public ResponseEntity<?> getLichSuMuonPhong() {
        ...
        for (YeuCauMuonPhong yeuCau : lichSuMuon) {
            ...
            yeuCauMap.put("maPhong", yeuCau.getPhong().getMaPhong());
            yeuCauMap.put("tenPhong", yeuCau.getPhong().getTenPhong());
            yeuCauMap.put("loaiPhong", yeuCau.getPhong().getLoaiPhong().toString());
            ...
            yeuCauMap.put("nguoiMuon", yeuCau.getNguoiMuon().getHoTen());
