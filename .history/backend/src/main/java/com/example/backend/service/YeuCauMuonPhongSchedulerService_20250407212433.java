...
import com.example.backend.model.ThongBaoNhan.TrangThai as ThongBaoTrangThai;
...
public class YeuCauMuonPhongSchedulerService {
    ...
    public void kiemTraVaCapNhatTrangThaiYeuCau() {
        ...
        List<YeuCauMuonPhong> danhSachYeuCau = yeuCauMuonPhongRepository.findByTrangThai(TrangThai.DADUYET);
        ...
        for (YeuCauMuonPhong yeuCau : danhSachYeuCau) {
            ...
            if (now.after(thoiGianTre.getTime())) {
                ...
                yeuCau.setTrangThai(TrangThai.KHONGDUOCDUYET);
                ...
                thongBaoNhan.setTrangThai(ThongBaoTrangThai.CHUADOC);
