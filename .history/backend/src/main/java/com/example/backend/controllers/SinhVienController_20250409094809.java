...
public class SinhVienController {
    ...
    public ResponseEntity<?> baoSuCo(@RequestBody Map<String, Object> suCoData) {
        ...
        try {
            // Sử dụng SuCoService để tạo báo cáo sự cố
            return suCoService.baoSuCo(
                sinhVien,
                yeuCau,
                maLichSu != null ? lichSuMuonPhongRepository.findById(maLichSu).orElse(null) : null,
                tieuDe != null ? tieuDe : "Báo cáo sự cố phòng " + yeuCau.getPhong().getMaPhong(),
                moTa,
                mucDoStr
            );
        } catch (Exception e) {
