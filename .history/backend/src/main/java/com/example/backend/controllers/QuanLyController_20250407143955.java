...
public class QuanLyController {
    ...
    @PreAuthorize("hasRole('QL')")
    public ResponseEntity<?> choMuonPhong(@PathVariable Integer maYeuCau) {
        QuanLy quanLy = getCurrentQuanLy();
        if (quanLy == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new MessageResponse("Không tìm thấy thông tin quản lý"));
        ...
        List<LichSuMuonPhong> existingLichSu = lichSuMuonPhongRepository.findByYeuCauMuonPhongMaYeuCau(maYeuCau);
        ...
        lichSu.setTrangThaiTra(null); // Trạng thái trả là rỗng
