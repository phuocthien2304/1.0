...
public class QuanLyController {
    ...
    public ResponseEntity<?> getDashboardStats() {
        try {
            ...
            sampleStats.put("totalRooms", 50);
            sampleStats.put("totalLecturers", 120);
            sampleStats.put("totalStudents", 3500);
            sampleStats.put("totalUsers", 3700);
            Map<String, Long> sampleRoomStatus = new HashMap<>();
            sampleRoomStatus.put("TRONG", 30L);
            sampleRoomStatus.put("DANGSUDUNG", 15L);
            sampleRoomStatus.put("BAOTRI", 5L);
            sampleStats.put("roomStatusCounts", sampleRoomStatus);
            sampleStats.put("activeBookings", 15);
            sampleStats.put("pendingBookings", 8);
            
            return ResponseEntity.ok(sampleStats);
        }
    }
    ...
    public ResponseEntity<?> getRoomFeedbackStatistics() {
        try {
            ...
            List<String[]> feedbacks = Arrays.asList(
                new String[]{"P201", "Tầng 2, Tòa A", "5.0", "Phòng rất rộng, thoáng mát và được trang bị đầy đủ thiết bị hiện đại.", "Nguyễn Văn A", "2", "1"},
                new String[]{"P401", "Tầng 4, Tòa C", "1.5", "Điều hòa bị hỏng, phòng rất nóng. Thiết bị đã cũ và không hoạt động tốt.", "Trần Thị B", "3", "2"},
                new String[]{"P305", "Tầng 3, Tòa B", "4.5", "Phòng học tốt, âm thanh rõ ràng, ánh sáng đầy đủ. Rất phù hợp cho các buổi thuyết trình.", "Lê Văn C", "5", "3"}
            );
            ...
            for (String[] feedback : feedbacks) {
                ...
                feedbackData.put("idPhanHoi", Integer.parseInt(feedback[6]));
