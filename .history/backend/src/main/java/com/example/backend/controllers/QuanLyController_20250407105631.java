...
public class QuanLyController {
    ...
    public ResponseEntity<?> getSinhVienKhongLop() {
        try {
            ...
            // Giả sử trường lớp trong SinhVien được gọi là "maLop" hoặc "lopHoc"
            ...
            for (SinhVien sv : allSinhVien) {
                ...
                // Chúng ta sẽ cần điều chỉnh dựa trên cấu trúc thực tế của class SinhVien
                String maLop = null;
            ...
            for (SinhVien sv : sinhVienKhongLop) {
                ...
                svInfo.put("hoTen", sv.getHoTen());
                
                // Thêm các trường khác tùy theo SinhVien class
                try { svInfo.put("email", sv.getEmail()); } catch (Exception e) {}
                try { svInfo.put("lienHe", sv.getLienHe()); } catch (Exception e) {}
                try { svInfo.put("gioiTinh", sv.getGioiTinh()); } catch (Exception e) {}
