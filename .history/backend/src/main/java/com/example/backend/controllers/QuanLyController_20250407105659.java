...
public class QuanLyController {
    ...
    public ResponseEntity<?> phanLopSinhVien(@RequestBody Map<String, Object> request) {
        try {
            ...
            // Giả lập việc cập nhật sinh viên vào lớp
            // Trong thực tế, cần thực hiện cập nhật trong database
            /*
            ...
            */
            ...
            response.put("message", "Đã phân lớp thành công cho " + maSinhViens.size() + " sinh viên");
