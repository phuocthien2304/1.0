...
public class SinhVienController {
    ...
    public ResponseEntity<?> baoSuCo(@RequestBody Map<String, Object> suCoData) {
        ...
        String tieuDe = (String) suCoData.get("tieuDe");
        String mucDoStr = (String) suCoData.get("mucDo");
        ...
        try {
            // Tạo dữ liệu cho báo cáo sự cố
            Map<String, Object> suCoMap = new HashMap<>();
            suCoMap.put("maSV", sinhVien.getMaSV());
            suCoMap.put("maPhong", yeuCau.getPhong().getMaPhong());
            suCoMap.put("tieuDe", tieuDe != null ? tieuDe : "Báo cáo sự cố phòng " + yeuCau.getPhong().getMaPhong());
            suCoMap.put("moTa", moTa);
            suCoMap.put("thoiGianBao", new Date());
            suCoMap.put("mucDo", mucDoStr != null ? mucDoStr : "TRUNGBINH");
            suCoMap.put("trangThai", "DABAOCAO");
            
            if (maYeuCau != null) {
                suCoMap.put("maYeuCau", maYeuCau);
            }
            
            if (lichSu != null) {
                suCoMap.put("maLichSu", lichSu.getMaLichSu());
            }
            
            // Gửi báo cáo sự cố và lưu vào cơ sở dữ liệu
            suCoService.taoVaLuuSuCo(suCoMap);
