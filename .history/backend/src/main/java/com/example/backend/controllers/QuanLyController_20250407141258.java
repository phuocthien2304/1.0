...
public class QuanLyController {
    ...
    public ResponseEntity<?> createTaiKhoan(@RequestBody TaiKhoanRequest taiKhoanRequest) {
        ...
        if ("SV".equals(vaiTro)) {
            ...
            System.out.println("SinhVien đã được tạo thành công với mã: " + maSV);
            ...
            System.out.println("GiangVien đã được tạo thành công với mã: " + maGV);
            ...
            System.out.println("QuanLy đã được tạo thành công với mã: " + maQL);
        }
