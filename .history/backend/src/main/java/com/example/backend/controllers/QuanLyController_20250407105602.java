    ...
    public ResponseEntity<?> getSinhVienKhongLop() {
        try {
            ...
            List<SinhVien> sinhVienKhongLop = allSinhVien.stream()
                    .filter(sv -> sv.getMaLop() == null || sv.getMaLop().trim().isEmpty())
                    .collect(Collectors.toList());
            ...
            for (SinhVien sv : sinhVienKhongLop) {
                ...
                svInfo.put("email", sv.getEmail());
                svInfo.put("lienHe", sv.getLienHe());
                svInfo.put("gioiTinh", sv.getGioiTinh());
                // Các thông tin khác có thể thêm tùy nhu cầu
