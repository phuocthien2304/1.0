...
public class SinhVienController {
    ...
    @GetMapping("/thongbao/danhsachlop")
    @PreAuthorize("hasRole('SV')")
        ...
        List<Map<String, Object>> result = danhSachNguoiDung.stream()
            ...
            .map(nd -> {
                ...
                if (nd.getVaiTro().getTenVaiTro().equals("GV")) {
                    ...
                    vaiTro = "Sinh viên";
                    SinhVien sv = sinhVienRepository.findByNguoiDungIdNguoiDung(nd.getIdNguoiDung());
                    if (sv != null && sv.getLopHoc() != null) {
                        nguoiDungInfo.put("maLop", sv.getLopHoc().getMaLop());
                    }
                }
