...
public class QuanLyController {
    ...
    public ResponseEntity<?> getDashboardStats() {
        ...
        long activeBookings = yeuCauMuonPhongRepository.countByTrangThaiAndThoiGianTraAfter(
            YeuCauMuonPhong.TrangThai.DADUYET, 
            new Date()
        );
        stats.put("activeBookings", activeBookings);
        
        // Số lượng yêu cầu mượn phòng đang chờ duyệt
        long pendingBookings = yeuCauMuonPhongRepository.countByTrangThai(YeuCauMuonPhong.TrangThai.DANGXULY);
