...
public class ThongBaoService {
    ...
    public List<Map<String, Object>> getNguoiNhanThongBao(Integer idThongBao, String idNguoiGui) {
        ...
        thongBaoNhans.forEach(tbn -> {
            System.out.println("ID: " + tbn.getId() + 
                              ", Người nhận: " + tbn.getNguoiNhan().getHoTen() + 
                              ", Trạng thái: " + tbn.getTrangThai());
        });
        return thongBaoNhans.stream().map(tbn -> {
            ...
            // Kiểm tra xem người nhận là sinh viên hay giảng viên
