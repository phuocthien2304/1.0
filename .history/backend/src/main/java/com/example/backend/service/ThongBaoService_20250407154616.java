...
public class ThongBaoService {
    ...
    public ThongBaoGui guiThongBao(NguoiDung nguoiGui, String tieuDe, String noiDung, String idNguoiNhan, String maLop) {
        ...
        if (idNguoiNhan != null && !idNguoiNhan.isEmpty()) {
            // Kiểm tra không cho phép gửi cho chính mình
            if (!idNguoiNhan.equals(nguoiGui.getIdNguoiDung())) {
        ...
        if (maLop != null && !maLop.isEmpty()) {
            ...
            for (SinhVien sinhVien : sinhViens) {
                ...
                if (!sinhVien.getNguoiDung().getIdNguoiDung().equals(nguoiGui.getIdNguoiDung())) {
        ...
        // Nếu không có người nhận nào, xóa thông báo gửi
        if (countNguoiNhan == 0) {
            thongBaoGuiRepository.delete(thongBaoGui);
            throw new IllegalArgumentException("Không có người nhận nào được thêm vào thông báo");
        }
