...
public class GiangVienController {
    ...
    public ResponseEntity<?> guiThongBao(@RequestBody ThongBaoRequest thongBaoRequest) {
        ...
        System.out.println("ThongBaoRequest: " + thongBaoRequest.getTieuDe() + ", " + thongBaoRequest.getNoiDung());
        System.out.println("DanhSachNguoiNhan: " + thongBaoRequest.getDanhSachNguoiNhan());
        System.out.println("GuiChoLop: " + thongBaoRequest.getGuiChoLop() + ", MaLop: " + thongBaoRequest.getMaLop());
        ...
        System.out.println("Đã tạo thông báo: idTB=" + thongBaoGui.getIdTB());
        ...
        if (thongBaoRequest.getDanhSachNguoiNhan() != null && !thongBaoRequest.getDanhSachNguoiNhan().isEmpty()) {
            for (String idNguoiNhan : thongBaoRequest.getDanhSachNguoiNhan()) {
                ...
                if (nguoiNhanOpt.isPresent()) {
                    ...
                    countNguoiNhan++;
                    System.out.println("Đã thêm người nhận: " + idNguoiNhan);
                }
            }
        }
        ...
        if (thongBaoRequest.getGuiChoLop() != null && thongBaoRequest.getGuiChoLop() 
            ...
            System.out.println("Gửi cho lớp " + maLop + ", số SV: " + danhSachSinhVien.size());
            ...
            for (SinhVien sinhVien : danhSachSinhVien) {
                ...
                thongBaoNhanRepository.save(thongBaoNhan);
                countNguoiNhan++;
                System.out.println("Đã thêm SV: " + sinhVien.getNguoiDung().getIdNguoiDung());
            }
        }
    ...
    public ResponseEntity<?> getDanhSachNguoiNhan() {
        ...
        List<Map<String, Object>> result = danhSachNguoiDung.stream()
            .filter(nd -> {
                // Chỉ lấy người dùng có vai trò là SV hoặc GV
            ...
            .map(nd -> {
                ...
                if (nd.getVaiTro().getTenVaiTro().equals("GV")) {
                    ...
                    // Tìm thông tin lớp học nếu là sinh viên
    ...
    public ResponseEntity<?> capNhatPhanHoi(@RequestBody PhanHoiRequest phanHoiRequest) {
        ...
        System.out.println("Yêu cầu cập nhật phản hồi GV: " + phanHoiRequest.getMaYeuCau() + ", đánh giá: " + phanHoiRequest.getDanhGia());
        ...
        // Log thông tin đã lưu để debug
        System.out.println("Đã cập nhật phản hồi ID: " + phanHoi.getIdPhanHoi() + ", đánh giá mới: " + phanHoi.getDanhGia());
