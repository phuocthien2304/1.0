...
public class QuanLyController {
    ...
    public ResponseEntity<?> createTaiKhoan(@RequestBody TaiKhoanRequest taiKhoanRequest) {
        ...
        System.out.println("Tạo tài khoản User: " + newUser);
        // Tạo NguoiDung
        ...
        System.out.println("Tạo NguoiDung: " + nguoiDung);
        ...
        if ("SV".equals(vaiTro)) {
            ...
            System.out.println("Tạo SinhVien: " + sinhVien);
            ...
            System.out.println("Tạo GiangVien: " + giangVien);
            ...
            System.out.println("Tạo QuanLy: " + newQuanLy);
        }
