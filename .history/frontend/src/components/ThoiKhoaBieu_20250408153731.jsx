...
import { Modal, Button, Table, Card, Badge, Spinner, Row, Col } from "react-bootstrap";
                  ...
                  {day.map((dayOfWeek, dayIndex) => {
                    ...
                    return (
                      <td key={dayOfWeek} 
                          ...
                          className={`${lesson ? "schedule-cell" : ""} ${isCurrentDay ? "current-day-cell" : ""} ${isMondayCell && !lesson ? "monday-empty-cell" : ""}`}>
                        {lesson && (
