                            ...
                            <div className="mb-4">
                              ...
                              <Row className="mb-4">
                                <Col md={12}>
                                  <Card>
                                    <Card.Body>
                                      <h5 className="mb-3">Lọc theo thời gian</h5>
                                      <Row>
                                        <Col md={4}>
                                          <Form.Group className="mb-2">
                                            ...
                                            <div className="d-flex align-items-center">
                                              <DatePicker
                                                selected={dateFilter.tuNgay}
                                                onChange={(date) => setDateFilter({ ...dateFilter, tuNgay: date })}
                                              ...
                                              <Button 
                                                ...
                                                size="sm"
                                                className="ms-2"
                                                onClick={() => setDateFilter({ ...dateFilter, tuNgay: null })}
                                              >
                                                Xóa
                                              </Button>
                                            </div>
                                        ...
                                        <Col md={4}>
                                          <Form.Group className="mb-2">
                                            ...
                                            <div className="d-flex align-items-center">
                                              <DatePicker
                                                selected={dateFilter.denNgay}
                                                onChange={(date) => setDateFilter({ ...dateFilter, denNgay: date })}
                                                dateFormat="dd/MM/yyyy"
                                                placeholderText="Chọn ngày kết thúc"
                                                className="form-control"
                                                minDate={dateFilter.tuNgay}
                                              />
                                              <Button 
                                                variant="outline-secondary" 
                                                size="sm"
                                                className="ms-2"
                                                onClick={() => setDateFilter({ ...dateFilter, denNgay: null })}
                                              >
                                                Xóa
                                              </Button>
                                            </div>
