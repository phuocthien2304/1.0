      ...
      <Row className="mb-5">
        <Col md={12} className="text-center">
          <div className="hero-section py-5">
            <h1 className="display-4 mb-3">Hệ Thống Quản Lý Đào Tạo</h1>
        ...
        <Col md={12}>
          <Card className="about-card">
            <Card.Body>
              ...
              <p>Hệ thống quản lý đào tạo được phát triển nhằm nâng cao hiệu quả quản lý và tổ chức các hoạt động đào tạo, giúp tiết kiệm thời gian và nguồn lực. Hệ thống được xây dựng với công nghệ hiện đại:</p>
              <Row className="mt-4">
                <Col md={6}>
