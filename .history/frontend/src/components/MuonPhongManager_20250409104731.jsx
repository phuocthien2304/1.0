...
const MuonPhongManager = ({ 
  ...
  const handleMuonPhongSubmit = async (e) => {
    ...
    try {
      ...
      setMuonPhongForm({ maPhong: "", thoiGianMuon: null, thoiGianTra: null, mucDich: "", soChoDat: "" });
  ...
  // Add a function to filter the available rooms based on soChoDat
            ...
            <Form onSubmit={handleMuonPhongSubmit}>
              <Form.Group className="mb-3">
                ...
                <Form.Text className="text-muted">
                  Nhập số chỗ cần đặt để xem danh sách phòng phù hợp
                </Form.Text>
              </Form.Group>
