          ...
          <div style={styles.footer}>
            <div style={styles.footerContainer}>
              ...
              <div style={styles.footerText}>
                <FaPhoneAlt style={{marginRight: '8px'}} /> Hotline: 0123-456-789
              </div>
              <div style={styles.footerText}>
                <FaEnvelope style={{marginRight: '8px'}} /> Email: support@muonphong.edu.vn
              </div>
              <div style={styles.footerText}>
                <FaMapMarkerAlt style={{marginRight: '8px'}} /> Địa chỉ: Số 1 Võ Văn Ngân, P. Linh Chiểu, TP. Thủ Đức, TP. Hồ Chí Minh
              </div>
              
              <div style={styles.footerDivider}></div>
              
              <p style={styles.footerText}>
                Hệ thống quản lý mượn phòng © {new Date().getFullYear()} - Bản quyền thuộc về Trường Đại học
              </p>
            </div>
          </div>
        </div>
