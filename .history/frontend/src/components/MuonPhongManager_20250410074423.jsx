...
const MuonPhongManager = ({ 
  ...
  const handleTimPhongTrong = async () => {
    try {
      ...
      const response = await UserService.timPhongTrong(muonPhongNangCaoForm.thoiGianMuon, muonPhongNangCaoForm.thoiGianTra, muonPhongNangCaoForm.soChoDat, muonPhongNangCaoForm.loaiPhong);
