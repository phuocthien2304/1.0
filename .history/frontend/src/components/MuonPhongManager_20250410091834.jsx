                    ...
                    {goiYPhongGanNhat.map((goiY, index) => (
                      <Card key={index} className="mb-2 room-card">
                        <Card.Body>
                          ...
                          <Card.Text className="mb-1">Thời gian trống: {formatDate(goiY.thoiGianMuon)} - {formatDate(goiY.thoiGianTra)}</Card.Text>
                          <Card.Text className="mb-1">
                            <small className="text-muted">
                              {tinhThoiGianTruoc(goiY.thoiGianMuon)} {goiY.thoiGianMuon > muonPhongNangCaoForm.thoiGianMuon ? 'sau' : 'trước'} thời gian yêu cầu
                            </small>
                          </Card.Text>
                          <Button 
                            variant="outline-primary" 
