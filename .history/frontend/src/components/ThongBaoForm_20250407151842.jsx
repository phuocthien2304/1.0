...
import { Form, Button, Card, Row, Col, InputGroup, Tabs, Tab } from "react-bootstrap";
...
const ThongBaoForm = ({ isGiangVien = false, onSuccess, onError, onSendComplete }) => {
  ...
  const fetchDanhSachNguoiNhan = async () => {
    try {
      ...
      const response = await UserService.getDanhSachNguoiNhanGV() 
