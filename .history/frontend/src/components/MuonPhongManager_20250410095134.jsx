...
const MuonPhongManager = ({ 
  ...
  const chonGoiY = (goiY) => {
    ...
    const thoiGianMuonGoiY = new Date(goiY.thoiGianMuonGoiY);
    const thoiGianTraGoiY = new Date(goiY.thoiGianTraGoiY);
    
    setMuonPhongNangCaoForm(prev => ({
      ...prev,
      maPhong: goiY.phong.maPhong,
      thoiGianMuon: thoiGianMuonGoiY,
      thoiGianTra: thoiGianTraGoiY
    }));
